...
function Cuestionary({ tiempo, setTiempo }: Props) {
    return (
        <div className='px-4 mt-12 bg-base-100  pt-6'>
            <h4 className='text-xl font-semibold font-Montserrat'>En qué horas de la mañana estás disponible para el trabajo?</h4>
